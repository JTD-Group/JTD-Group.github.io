...
<body>
  ...
  <main id="top" class="container">
    ...
    <footer>
      <div class="foot">
        <div>
          <div style="font-weight:900;color:rgba(243,243,243,.78);">Black<span style="color:var(--yellow)">Yellow</span> Logistics</div>
      ...
      <div style="margin-top:14px;color:rgba(243,243,243,.55);">
        © <span id="year"></span> Your Company Name. All rights reserved. • Privacy • Terms
      </div>
    </footer>
  </main>
